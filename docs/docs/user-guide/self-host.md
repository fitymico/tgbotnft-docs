...
Тариф **SELF-HOST** предназначен для тех, кто хочет запустить бота на собственном сервере с полным контролем.
...
## Шаг 3. Получите API ID и Hash

Следуйте инструкции в разделе [Получение API ID и Hash](./telegram-api).
